...
public class SOMusicRelease: SOMusicPlaylist, MusicRelease {
    ...
    public var musicReleaseFormatRawValue: NSNumber?
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let rawValue = try container.decodeIfPresent(String.self, forKey: .musicReleaseFormat) {
            self.musicReleaseFormat = MusicReleaseFormat(stringValue: rawValue)
        }
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.musicReleaseFormat?.stringValue, forKey: .musicReleaseFormat)
