...
public class SOCreativeWork: SOThing, CreativeWork {
    ...
    public var accessModeRawValue: NSNumber?
    ...
    public var accessModeSufficientsRawValue: [NSNumber]?
    /// Indicates that the resource is compatible with the referenced accessibility API
    public var accessibilityAPIRawValue: NSNumber?
    /// Identifies input methods that are sufficient to fully control the described resource
    public var accessibilityControlRawValue: NSNumber?
    /// Content features of the resource, such as accessible media, alternatives and supported enhancements for accessibility
    public var accessibilityFeatureRawValue: NSNumber?
    /// A characteristic of the described resource that is physiologically dangerous to some users.
    public var accessibilityHazardRawValue: NSNumber?
    ...
    public var commentCountRawValue: NSNumber?
    ...
    public var copyrightYearRawValue: NSNumber?
    ...
    public var interactivityTypeRawValue: NSNumber?
    ...
    public var isFamilyFriendlyRawValue: NSNumber?
    ...
    public required init(from decoder: Decoder) throws {
        ...
        if let value = try container.decodeIfPresent(String.self, forKey: .accessMode) {
            self.accessMode = AccessMode(stringValue: value)
        }
        if let value = try container.decodeArrayOrElementIfPresent(String.self, forKey: .accessModeSufficients) {
            ...
            value.forEach({ (v) in
                if let ams = AccessModeSufficient(stringValue: v) {
        ...
        if let value = try container.decodeIfPresent(String.self, forKey: .accessibilityAPI) {
            self.accessibilityAPI = AccessibilityAPI(stringValue: value)
        }
        if let value = try container.decodeIfPresent(String.self, forKey: .accessibilityControl) {
            self.accessibilityControl = AccessibilityControl(stringValue: value)
        }
        if let value = try container.decodeIfPresent(String.self, forKey: .accessibilityFeature) {
            self.accessibilityFeature = AccessibilityFeature(stringValue: value)
        }
        if let value = try container.decodeIfPresent(String.self, forKey: .accessibilityHazard) {
            self.accessibilityHazard = AccessibilityHazard(stringValue: value)
        }
        ...
        if let value = try container.decodeIfPresent(String.self, forKey: .interactivityType) {
            self.interactivityType = Interactivity(stringValue: value)
        }
    ...
    public override func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(self.accessibilityAPI?.stringValue, forKey: .accessibilityAPI)
        try container.encodeIfPresent(self.accessibilityControl?.stringValue, forKey: .accessibilityControl)
        try container.encodeIfPresent(self.accessibilityFeature?.stringValue, forKey: .accessibilityFeature)
        try container.encodeIfPresent(self.accessibilityHazard?.stringValue, forKey: .accessibilityHazard)
        ...
        try container.encodeIfPresent(self.interactivityType?.stringValue, forKey: .interactivityType)
