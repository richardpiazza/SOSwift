...
public class ItemList: Intangible {
    ...
    /// Text values are best if the elements in the list are plain strings. Existing entities
    /// are best for a simple, unordered list of existing things in your data. ListItem is
