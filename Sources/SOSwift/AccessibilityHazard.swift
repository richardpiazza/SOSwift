...
///
/// All three of the negative properties should be set if none of the hazards
/// are known to exist.
///
/// If the content has hazard(s), include positive assertions for the hazards it
/// has and negative assertions for the others.
///
/// If the property is not set in the positive or negative or is specifically
/// set to unknown, the state of hazards is not known.
