...
class DateOnlyOrDateTimeTests: XCTestCase {
    ...
    private var dateOnlyComponents: DateComponents {
        DateComponents(calendar: Calendar.current, timeZone: TimeZone.gmt, era: nil, year: 2017, month: 10, day: 26, hour: nil, minute: nil, second: nil, nanosecond: nil, weekday: nil, weekdayOrdinal: nil, quarter: nil, weekOfMonth: nil, weekOfYear: nil, yearForWeekOfYear: nil)
    }

    private var dateTimeComponents: DateComponents {
        DateComponents(calendar: Calendar.current, timeZone: TimeZone.gmt, era: nil, year: 2017, month: 10, day: 26, hour: 7, minute: 58, second: 0, nanosecond: nil, weekday: nil, weekdayOrdinal: nil, quarter: nil, weekOfMonth: nil, weekOfYear: nil, yearForWeekOfYear: nil)
    }
